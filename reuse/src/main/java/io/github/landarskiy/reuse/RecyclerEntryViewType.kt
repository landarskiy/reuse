...
/**
 * Makes relation between [Entry] and [RecyclerEntryViewType]
 */
interface RecyclerEntryViewType<T : Entry> {
     ...
     */
    fun createViewHolder(context: Context, parent: ViewGroup?): EntryViewHolder<T>
}